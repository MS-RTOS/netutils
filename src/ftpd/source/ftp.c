...
#else
#include <ms_rtos.h>
#define XFER_BUFFERSIZE 1024
#define SOCK_BUFFERSIZE 1024
#define FILE_BUFFERSIZE 1024
#define CMD_BUFFERSIZE  1024
#endif /* !defined(__MS_RTOS__) */
#else
...
#else
  char                 cwd[MS_IO_PATH_BUF_SIZE];  /*!< current working directory */
  char                 lwd[MS_IO_PATH_BUF_SIZE];  /*!< list working directory */
#endif /* !defined(__MS_RTOS__) */
